...
public class PowerSupplySearch extends HttpServlet {
   ...
   void search(String keyword1, String keyword2, String keyword3, String keywordPrice, HttpServletResponse response, HttpServletRequest request) throws IOException {
      ...
      out.println(docType + //
			...
			"</form>\n" + //
			"<button class=\"button-29\" role=\"button\"><a style=\"color:white; text-decoration:none;\" href=\"/webproject/powerSupplySearch.html\" id=\"backToFilter\">Back to Power Supply</a></button><p></p>\n" + //
    		  "</section>\n" + //
    		  "</nav>\n");
      ...
      try {
         ...
         if (check1 && check2 && check3) {
             ...
             out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">Efficiency</th>");
             out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">Wattage</th>");
             out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">Modular</th>");

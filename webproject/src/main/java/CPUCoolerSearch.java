...
public class CPUCoolerSearch extends HttpServlet {
   ...
   void search(String keyword1, String keyword2, String keywordPrice, HttpServletResponse response) throws IOException {
      ...
      out.println(docType + //
			...
			"</form>\n" + //
			"<button class=\"button-29\" role=\"button\"><a style=\"color:white; text-decoration:none;\" href=\"/webproject/cpuCoolerSearch.html\" id=\"backToFilter\">Back to CPU Cooler</a></button><p></p>\n" + //
			  "</section>\n" + //
			  "</nav>\n");
      ...
      try {
         ...
         out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">Air/Water</th>");
         out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">RPM</th>");

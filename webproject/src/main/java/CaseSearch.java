   ...
   void search(String keyword1, String keyword2, String keywordPrice, HttpServletResponse response, HttpServletRequest request) throws IOException {
	   response.setContentType("text/html");
	      ...
	      out.println(docType + //
			...
			"</form>\n" + //
			"<button class=\"button-29\" role=\"button\"><a style=\"color:white; text-decoration:none;\" href=\"/webproject/caseSearch.html\" id=\"backToFilter\">Back to Case Filter</a></button><p></p>\n" + //
    		  "</section>\n" + //
    		  "</nav>\n");
      ...
      try {
         ...
         out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">Fans</th>");
         out.println("<th style=\"background-color:rgba(0, 0, 0, 0.6); color:white; font-family:'Franklin Gothic Medium', 'Arial', Arial, sans-serif\">RGB</th>");

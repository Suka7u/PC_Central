...
public class ProvidingIncorrectCredentialsWhenLoggingIn {
  ...
  @Test
  public void testProvidingIncorrectCredentialsWhenLoggingIn() throws Exception {
    ...
    driver.findElement(By.name("username")).sendKeys("donkeyKong");

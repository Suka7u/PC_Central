...
public class ViewPresetBuilds {
  ...
  @Test
  public void testViewPresetBuilds() throws Exception {
    ...
    driver.get("http://ec2-3-139-67-4.us-east-2.compute.amazonaws.com:8080/webproject/homePage.html");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Log Out'])[1]/following::input[3]")).click();
    driver.get("http://ec2-3-139-67-4.us-east-2.compute.amazonaws.com:8080/webproject/CheckIfLoggedIn");
    driver.get("http://ec2-3-139-67-4.us-east-2.compute.amazonaws.com:8080/webproject/presetBuilds.html");
  }

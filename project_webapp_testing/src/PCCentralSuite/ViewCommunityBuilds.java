...
public class ViewCommunityBuilds {
  ...
  @Test
  public void testViewCommunityBuilds() throws Exception {
    driver.get("http://ec2-3-139-67-4.us-east-2.compute.amazonaws.com:8080/webproject/homePage.html");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Login or Sign up'])[1]/following::input[2]")).click();
